...
function setR11Tooltip(){
	...
	dawg.setAttribute('ach-tooltip', "Have all your past 10 Infinities be at least "+shortenMoney(Number.MAX_VALUE)+" times higher IP than the previous one. Reward: Antimatter doesn't reset on a Dimension Boost or Galaxy.")
...
function setR15Tooltip(){
	...
	hadron.setAttribute('ach-tooltip', "Have colored anti-quarks, but have no color charge. Reward: Net Quarks boost all Meta Dimensions.")
...
function setR20Tooltip(){
	...
	//ACHIEVEMENT ROW 20
	keeheehee.setAttribute('ach-tooltip', "Go Fundament. Reward: Start with " + getFullExpansion(100) + " banked Eternities, " + shorten(Number.MAX_VALUE) + " aQ features, and obtain all missing achievements prior to Paired Challenges.")
	finite.setAttribute('ach-tooltip', "Get " + shortenCosts(1e33) + " Space Shards without Breaking Eternity in this Fundament. Reward: Outside of Big Rips, Tree Upgrades are 10% stronger.")
	...
	oppose.setAttribute('ach-tooltip', "Fundament with at most 1x Quantumed.")
...
function setR21Tooltip(){
	...
	mi.setAttribute('ach-tooltip', "Get "+shorten(Number.MAX_VALUE)+" Infinities. Reward: Start with 100 banked Infinities.")
