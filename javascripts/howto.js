let HOW_TO = [
	{
		...
		desc: `
			...
			Some milestones boost Bosons, so make sure to setup presets! I recommend joining the NG+3 Discord server for further help. At least two presets are recommended for progression.
		`
	}, {
		mod: _ => ngp3,
		req: _ => ghSave?.hb?.unl,
		...
		layer: "fundament",
		desc: `
			At ??? Bosons, you can reset W & Z Bosons for Higgs. The first Higgs reset unlocks Higgs Field. Further Higgs resets require more Higgs. Unlike Dimensional Boosts and Galaxies, Higgs can be increased by any amount in one run.<br><br>
