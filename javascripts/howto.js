let HOW_TO = [
	{
		...
		Note: Pilon charge, energy, anti-energy, and power all reset on Quantum. You keep all rewards you already earned.`
	}, {
		mod: _ => ngp3,
		...
		desc: `
			...
			Brave Milestones can be achieved by going Fundament while going Quantums as least as you can. Like Speedrun Milestones, each Brave Milestone provides you with a reward that greatly boosts progress and makes Fundaments much faster and more efficient.
			<br><br>

			<b>Automators</b><br>
			Automator Charge is based on net Quarks and other stuff you'll gain later. Automator Power is your best-ever Automator Charge, but is used on enabling an Automator. Automators automate various features such as Nanofield and Big Rips, as long the your used power doesn't exceed the cap. You unlock an Automator on passing a certain threshold of Automator Power.
		`
	}, {
		mod: _ => ngp3,
		req: _ => ghSave?.times,
		...
		desc: `
			...
			Milestones provide with a variety of effects. I recommend joining <a href="http://discord.gg/KsjcgskgTj" target="_newtab">the NG+3 Discord server</a> for sharing presets to the community.
		`
	}, {
		mod: _ => ngp3,
		req: _ => ghSave?.hb?.unl,
