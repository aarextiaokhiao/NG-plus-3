let HOW_TO = [
	{
		...
		desc() {
			...
			if (ghSave?.photons?.unl || SPOILERS) msg += `<b>Radioactive Decays</b><br>
				When you have enough Free Preons, you will be able to sacrifice some Branch Upgrades and Free Preons in order to provide some boosts and unlock new upgrades. However, each Decay greatly nerfs Decay except the upgrades on the bottom!`
