let HOW_TO = [
	{
		...
		desc() {
			...
			You can exit Big Rip anytime to gain Space Shards based on antimatter gained during your current run. You can spend Space Shards to buy various progression upgrades, either by giving a boost or a quality-of-life feature that only applies in Big Rips, or letting you keep something inside Big Rips.<br><br>`
		...
		desc: `
			...
			Some milestones can boost Bosons, so I recommend having some presets for progression! I recommend joining the NG+3 Discord server for further help.
		`
	}, {
		mod: _ => ngp3,
		req: _ => ghSave?.hb?.unl,
