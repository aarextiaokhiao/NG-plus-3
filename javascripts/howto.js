let HOW_TO = [
	{
		...
		You can assign each of the four paired challenges to any pair of Quantum Challenges, though the same challenge can't be used twice. You can respec the assignments at any time, though you will lose the Paired Challenges you already completed.<br><br>
		...
		desc() {
			...
			You can exit Big Rip anytime to gain Space Shards based on antimatter during your current run. You can spend Space Shards to buy various progression upgrades for boosts, keepings, and QoL features exclusive to Big Rips.<br><br>`
		...
		layer: "fundament",
		desc: `
			There are 3 kinds of Neutrinos: Electron, Mu, and Tau. You gain Neutrinos for each Antimatter Galaxy you gain, but in only of the kind you are generating.<br>
		...
		desc: `
			...
			Each type of hypercharges provides a set of milestones that are independent to other type.<br>
			Milestones provide with a variety of effects. I recommend joining <a href="http://discord.gg/KsjcgskgTj" target="_newtab">the NG+3 Discord server</a> for further help and sharing presets.
		`
	}, {
		mod: _ => ngp3,
		req: _ => ghSave?.hb?.unl,
		...
		desc: `
			...
			Higgs Field has a grid of swappable boosts. You produce Higgs Mass which strengthens all boosts from Higgs Field. Lowermost rows start as weak with low amount of Higgs Mass, but gradually increase to be effective as the first row on gaining more.
		`,
	}/*, {
		mod: _ => ngp3,
		req: _ => ghSave?.gw?.unl,
