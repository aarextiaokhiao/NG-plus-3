let HOW_TO = [
	{
		...
		desc: `
			...
			Hypercharges are separate resources that don't increase each other. Instead, they provide independent milestones. Some milestones boost Bosons, so make sure to have presets to setup different effects!
		`
	}, {
		mod: _ => ngp3,
		req: _ => ghSave?.hb?.unl,
