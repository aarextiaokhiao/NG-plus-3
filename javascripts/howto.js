let HOW_TO = [
	{
		...
		Unlike the normal counterpart, Meta-Dimension Boosts do not affect anything prior to Meta Dimensions. There are no Meta-Tickspeed and Meta-Galaxies.`
	}, {
		mod: _ => ngp3,
		...
		desc() {
			...
			if (ghSave?.photons?.unl || SPOILERS) msg += `<b>Radioactive Decays</b><br>
				When you have enough Free Preons, you will be able to sacrifice some Branch Upgrades and Free Preons in order to provide some boosts. However, each Decay nerfs Decay severally except the upgrades on the bottom!`
		...
		desc() {
			...
			You can exit Big Rip anytime to gain Space Shards based on antimatter during your current run. You can spend Space Shards to buy various progression upgrades for boosts and QoL features exclusive to Big Rips.<br><br>`
			...
			if (feature == 3) msg += `<b>Phantomal Paradigms</b><br>
				Phantomal Paradigms are a Big Rip replacement to Dimensional Shifts. Each Phantomal Paradigm removes the cost scaling of a Antimatter Dimension tier (except the 8th), but will have a constant per-ten bonus. Additionally, one of each Infinity & Time Dimensions will be removed and you will be stuck in Big Rips until next Fundament.<br><br>
		...
		desc: `
			...
			Brave Milestones can be achieved by going Fundament while going Quantums as least as you can. Like Speedrun Milestones, each Brave Milestone provides you with a reward that greatly boosts progress and makes Fundaments more efficient.
			<br><br>
