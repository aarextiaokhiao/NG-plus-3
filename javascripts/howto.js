let HOW_TO = [
	{
		...
		desc() {
			...
			You can exit Big Rip anytime to gain Space Shards based on antimatter gained during your current run. You can spend Space Shards to buy various progression upgrades for boosts, keepings, and QoL features exclusive to Big Rips.<br><br>`
		...
		layer: "fundament",
		desc: `
			Tachyonic Galaxies generate Photons, which strengthen Lights. To unlock more colors of Lights, you must gain more Photons. However, going Fundament resets Photons and Lights.
			<br><br>
		...
		desc: `
			...
			Higgs Field has a grid of swappable boosts. You produce Higgs Mass which strengthens all boosts from Higgs Field. Later rows are weak with low amounts of Higgs Mass, but gradually increase to be effective as you gain more.
		`,
	}/*, {
		mod: _ => ngp3,
		req: _ => ghSave?.gw?.unl,
