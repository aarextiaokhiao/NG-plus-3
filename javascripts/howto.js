let HOW_TO = [
	{
		...
		desc() {
			...
			if (feature == 3) msg += `<b>Phantomal Paradigms</b><br>
				Phantomal Paradigms are a Big Rip replacement to Dimensional Shifts. Each Phantomal Paradigm removes the cost scaling of a Antimatter Dimension tier (except the 8th), but will have a constant per-ten bonus. Additionally, other Dimensions will be removed.<br><br>
