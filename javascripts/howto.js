let HOW_TO = [
	{
		...
		desc() {
			...
			if (ghSave?.photons?.unl || SPOILERS) msg += `<b>Radioactive Decays</b><br>
				When you have enough Free Preons, you will be able to sacrifice some upgrades and Free Preons for boosts and new upgrades. However, each Radioactive Decay greatly nerfs Decay!`
