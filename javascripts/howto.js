let HOW_TO = [
	{
		...
		title: "Black Hole",
		layer: "eternity",
		desc: `On spending e4K EP, several resources can be exchanged for Remnants. Your Black Hole generates hunger. Feeding with Remnants not only reduces hunger, but also unlocks various boosts based on the power.`
	}, {
		...
		desc: `
			...
			On going Quantum will switch a generating kind of Neutrinos. You'll keep prior Neutrinos you generated. However, Fundamenting resets Neutrinos of every kind.
			<br><br>
		...
		layer: "fundament",
		desc: `
			At ??? Bosons, you can reset Bosons and W & Z Bosons for Higgs. The first Higgs reset unlocks Higgs Field. Further Higgs resets require more Higgs. Unlike Dimensional Boosts and Galaxies, it can be performed multiple times in one click.<br><br>
