...
['Well, this game is unique now. So unique, that it claims the throne from Distance Incremental.', "tmp.ngp3", "am186"],
['NG+3R witnesses say that Fluctuate should be here. Here, just wind blows.', "tmp.ngp3", "am187"],
...
["Are we in the Gravity Well or outside of it?", "tmp.ngp3 && ghSave.gravitons.unl", "am195"],
["'The Power of Relativity'", "tmp.ngp3 && ghSave.gravitons.unl", "am196"],
["Gravity Well is basically the time part of dilation, but better.", "tmp.ngp3 && ghSave.gravitons.unl", "am197"],
...
["Scientists discovered a brand new universe which is made of Replicantis!", "tmp.ngp3 && player.masterystudies.includes('d11')", "am201"],
...
["Coming soon: NG+Pi. ETA: We don't have a release date. There is a possibility that it takes infinite time.", "tmp.ngp3", "am210"],
...
["Meta-antimatter decays particles for quantum energy. That means we can decay anything for quantum energy?", "tmp.ngp3 && player.masterystudies.includes('d10')", "am229"],
["You have e3.523 DCe unmeta-antimatter, which causes a e1.762 DCex expansion to real-life.", "tmp.ngp3", "am230"],
...
["Local replicant paralyzed after eating 413 quantum food", "tmp.ngp3 && player.masterystudies.includes('d10')", "am235"],
...
["Duplicants and ghosts reported that Aarex went missing from Bosonic Lab! He is planning to destroy our places!", "tmp.ngp3 && ghSave.wzb.unl", "am263"],
["Florida man reports that replicants and ghosts were erdiciated by Aarex!", "tmp.ngp3", "am264"],
["Strings are for smart nerds.", "tmp.ngp3 && player.masterystudies.includes('d12')", "am265"],
["Sorry, but we actually made of strings. That's what everything does.", "tmp.ngp3 && player.masterystudies.includes('d12')", "am266"],
["Strings can't fold like that! It actually become complex shapes!", "tmp.ngp3 && player.masterystudies.includes('d12')", "am267"],
["Down deep at the microscopic scale, walls seem to be really cool decorations there. Thanks, strings for arranging on my [walls!]", "tmp.ngp3 && player.masterystudies.includes('d12')", "am268"],
["Welcome to Deep Quantum, where strings are everywhere.", "tmp.ngp3 && player.masterystudies.includes('d12')", "am269"],
["Number of perfect lines: Absolutely zero.", "tmp.ngp3 && player.masterystudies.includes('d12')", "am270"],
["Absolute zero. That's how many particles didn't contain.", "tmp.ngp3 && player.masterystudies.includes('d12')", "am271"],
...
/* Post-NG+3R: 300 - ??? */
["Gravity seems to so strong, that it intensifies anything.", 'tmp.ngp3 && ghSave.gravitons.unl', "am301"],
