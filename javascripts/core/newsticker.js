...
["Is there meta-infinity?", '(mod.ngpp ? player.meta.bestAntimatter.gte(Number.MAX_VALUE) : false)', "am10"],
...
["How are your few thousand electrons not annihilating the positrons that presumably are part of the e100,000,000,000's of antimatter you've built up?", "(player.masterystudies !== undefined ? hasMasteryStudy('d7') : false)", "am78"],
...
["Having fun destabilizing?", '(player.masterystudies !== undefined ? hasMasteryStudy("d13") && !(GUBought("rg7") && GUBought("gb7") && GUBought("br7")) : false)', "am97"],
...
["Why are we getting electrons when electrons are matter?", '(player.masterystudies !== undefined ? hasMasteryStudy("d7") : false)', "am100"],
...
["AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAarex is a nice person", '(inNGM(3) || player.masterystudies !== undefined)', "am106"],
...
["Quantum Challenges are not challenging enough.", "player.masterystudies !== undefined && hasMasteryStudy('d9')", "am133"],
...
['"Anti-pilons are coming. They will destroy our Nanofield work. We are doomed." ~ Worker replicant #179,769,308.', 'hasAch("ng3p81")', "am137"],
...
["Quark Decay isn't a upgrade tree, I have been lied to", "player.masterystudies !== undefined && hasMasteryStudy('d13')", "am151"],
["ELECTRONS CONSUME YOUR STARS", "player.masterystudies !== undefined && hasMasteryStudy('d7')", "am152"],
...
["Can you buy max Spectral Ions?", "ghostified && ghSave.ghostlyPhotons.enpowerments >= 3", "am169"],
...
["Local replicant paralyzed after eating 413 quantum food", "hasMasteryStudy('d10')", "am235"],
...
["antimatter dimensions NG+3R! Now with 100% more balancing! + less boosts that become useless. + hyperexponential upgrades.", "mod.ngp3", "am254"],
...
["NG+3R Starter Pack: Creative mechanics, ideal dump, focuses on balancing a lot, a bit of development every day.", "mod.ngp3", "am257"],
...
["Florida man reports that replicants and ghosts were erdiciated by Aarex!", "mod.ngp3", "am264"],
...
["You got Spectral Ions? That means you have Ghostly Light inside of you! Kee-hee-hee!", "ghSave.ghostlyPhotons.enpowerments", "gn22"],
