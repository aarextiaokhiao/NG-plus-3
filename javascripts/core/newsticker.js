...
["If you want to time travel, you need to learn how to pass time first. To do that, you need to fundament too.", "player.masterystudies !== undefined", "am46"],
["If you are a ghost, try to click me!", "player.masterystudies !== undefined", "am47"],
["Soon(TM)", "(player.masterystudies !== undefined ? brSave.bestAntimatter.gte(pow10(155887875)) : false)", "am48"],
...
["No. You are not really at current end-game.", "(player.masterystudies !== undefined ? brSave.bestAntimatter.gte(pow10(1e9)) : false)", "am52"],
["Congratulations for beating NG+3! (for now...) A secret is unlocked in Ghostly News Ticker...", "player.totalmoney.gte(pow10(1e100))", "am53"],
...
["Waiting I see", '(player.masterystudies !== undefined ? nfSave.rewards > 14 : false)', "am118"],
...
["The invasion of the battle duplicants has been postponed indefinitely. Everyone, please remain calm!", "player.masterystudies && player.masterystudies.includes('d12')", "am161"],
...
["It's photons, not protons!", "ghostified && ghSave.ghostlyPhotons.unl", "am167"],
["Why would you dilate a ghost", "ghostified", "am168"],
["Can you buy max light empowerments?", "ghostified && ghSave.ghostlyPhotons.enpowerments >= 3", "am169"],
...
["Photons can't emit light. They emit ghostly light!", "hasAch('ng3p71')", "gn21"],
...
["WARNING! The Anti-Preonius will control over your Nanofield! Be careful! Oh. Worker duplicants are warned of that Ghost too.", "tmp.bl.upgrades.includes(21)", "gn34"],
