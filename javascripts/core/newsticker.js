...
["What's next? NG+4? (Load > New Game > Mods > Advanced > NG++ x2)", "mod.ngp3", "am58"],
...
["Meta-Tickspeed when?", "player.dilation.studies.includes(6)", "am117"],
["Waiting I see...", 'nfSave?.rewards > 14', "am118"],
...
["You chose poorly.", "quantumed && quSave.times == 1 && quSave.usedQuarks.b.gt(0)", "am124"],
...
["The invasion of the battle duplicants has been postponed indefinitely. Everyone, please remain calm!", "hasMasteryStudy('d12')", "am161"],
...
["Breaking Dilation is something to do with Study 999", "ghostified", "am169"], 
...
["This news ticker has been softcapped so you can't read the re-.", "mod.ngp3", "am188"]
...
["We are getting close to the true nature of Quantum. More to soon...", "ghostified", "am284"],
...
function updateGhostlyNewsArray() {
	...
	["How do you play this when you became a real ghost?", true, "gn10"],
	...
	['Look around your screen. Are you a ghost or a human?', true, "gn24"],
	...
	["Wait a second. This new laboratory isn't anti-Nanofield...", "hasAch('ng3p81')", "gn39"],
	...
	["Ghostly news company has become partners with us. This brings more news to all ghosts.", true, "gn46"],
	["Antimatter ghosts do not exist. Just like matter ghosts. But Ghostly Matter Ghosts do.", true, "gn47"],
	["I am a ghost, and I will do science for all eternity!", "hasAch('ng3p81')", "gn48"],
	...
	["We built a new tool for solving the mystery of ghosts!", true, "gn61"],
	["We found an anomaly that allows ghosts to be visible in their worlds.", true, "gn62"],
	["Getting tired of being stuck in small holes? Introducing Planckizer! A tool which allows ghosts to shrink down into planck-scale!", true, "gn63"],
	...
	["A detective ghost, Ms. Koolka, has disappeared. The team is currently investigating to see he's gone from existence.", "hasAch('ng3p81')", "gn72"],
	...
	["Ghost's note: Research how ghosts didn't appear.", true, "gn75"],
