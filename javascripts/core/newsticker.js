...
["Did you just do 4 modes at once? Impossible!", 'aarMod.newGameMinusVersion && inNGM(2) && aarMod.newGamePlusVersion && mod.ngpp', "am6"],
...
["Whale complained that Infinity Challenge 5 is not the hardest.", 'mod.ngp3', "am19"],
...
["Did you know that NG-3 nerfs NG-- to make short runs longer?", "inNGM(3)", "am24"],
["I guess NG-4 would be coming if NG-3 is too easy.", "inNGM(3)", "am25"],
["I don't really think I am an A.I.", true, "am27"],
["Somebody think you get your first galactic sacrifice faster than NG--. An update will be coming soon!", "inNGM(3)", "am28"],
...
["Rumors said the Photon Wall is actually consists of frozen time.", "ghostified", "am38"],
...
["Defeat antimatter to gain quarks!", "mod.ngp3", "am41"],
["Oh no! Someone beat my antimatter amount! I was going to develop a side project, but I must catch up!", "mod.ngp3", "am42"],
["Fundament means Fundament. It's actually a prestige layer.", "mod.ngp3", "am43"],
...
["What's next? NG+4? (Load > New Game > Mods > Checkpoint x2)", "mod.ngp3", "am58"],
...
["How are your few thousand electrons not annihilating the positrons that presumably are part of the e100,000,000,000's of antimatter you've built up?", "(mod.ngp3 ? hasMasteryStudy('d7') : false)", "am78"],
...
["Onionify: Coming in December 32nd to NG+3. Make onions dominate antimatter with this prestige layer!", "player.newsArray.includes('am85')", "am88"],
...
["Having fun waiting?", 'NF.unl() && nfSave.rewards < 16', "am96"],
["Having fun destabilizing?", 'hasMasteryStudy("d13") && !(hasGluonUpg("rg7") && hasGluonUpg("gb7") && hasGluonUpg("br7"))', "am97"],
...
["Study 999 allows you to get meta antimatter galaxies.", 'mod.ngp3', "am101"],
["Having fun cutting on onions?", "player.newsArray.includes('am85')", "am102"],
...
["Study 999 will never exist.", 'mod.ngp3', "am105"],
["AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAarex is a nice person", '(inNGM(3) || mod.ngp3)', "am106"],
...
["Florida man puts tetraethyllead in Aarex's car so he has to stay at home so he can update NG+++", 'mod.ngp3', "am112"],
...
["Waiting I see...", '(mod.ngp3 ? nfSave.rewards > 14 : false)', "am118"],
...
["no cheating", '(player.bestInfinityTime < 1 || player.bestEterTime < 1 || (mod.ngp3 ? quSave.best < 1 || ghSave.best < 1 : false))', "am121"],
...
["Eternity Challenge 10 is confirmed to be a boost!", "tmp.be", "am125"],
["When will Trio Challenges be released?!", "hasAch('ng3p25')", "am126"],
["Welcome to the hell of NG-.", "inNGM(3)", "am127"],
["If NGUd+ is a combination of NG+3 and NGUd, then why isn't NGUd' a combination of NG' and NGUd?", "mod.udp", "am129"],
["Congratulations for beating NG-3! (for now...)", "inNGM(3) && player.postChallUnlocked > 5", "am130"],
["Progressing as a Ghost...", "PHOTON.unlocked()", "am131"],
["VROOOOOOM!!!", "player.infinityUpgrades.includes('postGalaxy')", "am132"],
["Quantum Challenges are not challenging enough.", "mod.ngp3 && hasMasteryStudy('d9')", "am133"],
...
["BOSONIC OVERDRIVE!!!", 'hasAch("ng3p81") && blSave.odSpeed.gt(1) && blSave.battery.gt(0)', "am142"],
...
["The invasion of the battle duplicants has been postponed indefinitely. Everyone, please remain calm!", "player.masterystudies && hasMasteryStudy('d12')", "am161"],
...
["It's photons, not protons!", "PHOTON.unlocked()", "am167"],
["Why would you dilate a ghost", "ghostified", "am168"],
["Can you buy max Spectral Ions?", "false", "am169"], //future gph progression
...
['Well, this game is unique now. So unique, that it claims the throne from Distance Incremental.', "mod.ngp3", "am186"],
...
["The Photonic Wall seems to be gone, but there's only the bricks of it left. We should maybe do stuff with those bricks, except they might be made out of concentrated time, so that's a bad idea...", true, "am191"],
...
["Are we in the Gravity Well or outside of it?", "mod.ngp3 && ghSave.gravitons.unl", "am195"],
["'The Power of Relativity'", "mod.ngp3 && ghSave.gravitons.unl", "am196"],
["Gravity Well is basically the time part of dilation, but better.", "mod.ngp3 && ghSave.gravitons.unl", "am197"],
...
["Antimatter Decay goes brrr!", 'hasAch("ng3p74")', "am202"],
["We recently proved that dark matter exists. We still don't know why.", "hasAch('ng3p71')", "am203"],
["Wait... Ghosts should live in spooky places, not our universe.", "ghostified", "am204"],
["When quarks have gone radioactive, the atom becomes a level that goes beyond radioactivity. Scientists call this level 'quarkfusey.'", "ghostified", "am205"],
["Scientific fact: The hotter the atom gets, the more radioactive it gets. Wait... Is this proven by the reactor?", "ghostified", "am206"],
...
["Who thought that Expert Mode should nerf the production all of times? It should give players how to do strategies properly! Not just add timewalls! That's wrong, and it will be like- another generic NG- mod!", "aarMod.newGameMinusVersion", "am234"],
...
["The year is 2025. Aarex has released Hadronize. But due to a lot of uprising competition, NG+3 became unfairly popular. NG+3 will be likely to be at least dead. He has finally moved on.", true, "am253"],
...
["This number changes dependent on the notation you are using: 1.23413e251 (only happens in NG+3R, sorry.)", true, "am255"],
["According to the lore, we can confirm that Omnisity is going to be the last layer.", "mod.ngp3", "am256"],
["Post-NG+3 Starter Pack: Creative mechanics, ideal dump, focuses on balancing a lot, a bit of development every day.", "mod.ngp3", "am257"],
...
["Strings are for smart nerds.", "hasMasteryStudy('d12')", "am265"],
["Sorry, but we actually made of strings. That's what everything does.", "hasMasteryStudy('d12')", "am266"],
["Strings can't fold like that! It actually become complex shapes!", "hasMasteryStudy('d12')", "am267"],
["Down deep at the microscopic scale, walls seem to be really cool decorations there. Thanks, strings for arranging on my [walls!]", "hasMasteryStudy('d12')", "am268"],
["Welcome to Deep Quantum, where strings are everywhere.", "hasMasteryStudy('d12')", "am269"],
["Number of perfect lines: Absolutely zero.", "hasMasteryStudy('d12')", "am270"],
["Absolute zero. That's how many particles didn't contain.", "hasMasteryStudy('d12')", "am271"],
...
function updateGhostlyNewsArray() {
	...
	["If you read 'Congratulations for beating NG+3' message, here is a spoiler: In the next update, there will be Higgs!", "player.newsArray.includes('am68') && player.totalmoney.gte(pow10(2e17))", "gn17"],
	...
	["You got Spectral Ions? That means you have Ghostly Light inside of you! Kee-hee-hee!", "PHOTONS.unlocked()", "gn22"],
	...
	["WARNING! The Anti-Preonius will control over your Nanofield! Be careful! Oh. Worker duplicants are warned of that Ghost too.", "hasBU(21)", "gn34"],
	...
	["You got one ghostly particle, whatever that means.", "hasBU(21)", "gn36"],
	...
	["Wait a second. This new laboratory isn't anti-Nanofield...", "hasBU(21)", "gn39"],
	...
	["Void-Preonius, the Void Ultra-Omnipotent Ghost, decided to take over not only the Barrel... He took over the Barrel!", true, "gn57"],
	["GHOST IS YOU", true, "gn58"],
	["Error 404: Ghost Matter not found", true, "gn59"],
	["Ghost scientists have built a quick transportation to the Gravity Well!", 'ghSave.gravitons.unl', "gn60"],
