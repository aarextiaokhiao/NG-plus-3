...
["Congraulations for beating NG+++! (for now...) The next update will include Replicants! Here is the very long information: - When your replicanti amount reaches the replicant gain requirement, you will be able to reset replicanti amount for a replicant. However, you will gain less replicanti in the same time length and the requirement will be increased. - Replicants can gather quarks for extra replicated galaxy multiplier. - You can buy quantum food by spending all 3 types of same-amount gluons. To get a replicant worker, you have to feed normal replicants with several quantum food. However, there is the limit of workers that can be increased by spending gluons. - Workers can lay eggons. 1 eggon will be hatched per fixed time length for baby replicants. - Babies would gather quarks slower. Normal replicants and you can feed them to become a normal one with less quantum food than workers’ needs. When you feed babies, quantum food will be cheaper. - Replicants will be resetted upon quantum, but workers and quantum food won't.", "player.achievements.includes('r22') && player.totalMoney.gt(Decimal.pow(10, 12e12))", "am16"],
