...
function getTickSpeedMultiplier() {
	...
	if (player.masterystudies) realnormalgalaxies = Math.max((player.galaxies-player.quantum.electrons.sacGals)*Math.max(Math.min(10-player.quantum.electrons.sacGals/1850,1),0),0)
