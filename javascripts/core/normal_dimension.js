...
function getDimensionFinalMultiplier(tier) {
	...
	if (tmp.ngp3 && player.dilation.active) mult = mult.pow(getNanofieldRewardEffect(5, "dil_exp"))
...
function getDimensionProductionPerSecond(tier) {
	...
	if (player.dilation.active && player.masterystudies != undefined) tick = tick.pow(getNanofieldRewardEffect(5, "dil_exp"))
	ret = ret.times(tick)
	return ret
}
