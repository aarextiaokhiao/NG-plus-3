...
dev.ghostify = function(gain, amount, seconds=4) {
	...
	setTimeout(function() {
		document.getElementById("ghostifyanigained").innerHTML = ghostified ? "You now have <b>" + shortenDimensions(gain) + "</b> Ghost Particles. (+" + shortenDimensions(amount) + ")" : "Congratulations for beating a PC with QCs 6 & 8 combination!"
