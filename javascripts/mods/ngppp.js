...
function getGHPGain() {
	...
	return player.quantum.bigRip.bestThisRun.div(Decimal.pow(10, getQCGoal())).pow(25e-9).times(Decimal.pow(2, player.ghostify.multPower - 1)).floor()
}
...
function ghostify() {
	...
	if (!ghostified) {
		...
		if (!confirm("ARE YOU REALLY SURE YOU WANT TO DO THAT? YOU WON'T UNDO THIS AFTER YOU BECAME A GHOST AND PASS THE UNIVERSE EVEN IT IS BIG RIPPED! THIS IS YOUR LAST CHANCE!")) return
	}
