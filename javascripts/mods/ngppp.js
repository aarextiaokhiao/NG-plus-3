masterystudies={initialCosts:{time:{241: 1e71, 251: 2e71, 252: 2e71, 253: 2e71, 261: 5e71, 262: 5e71, 263: 5e71, 264: 5e71, 265: 5e71, 266: 5e71, 271: 2.7434842249657063e76, 
	272: 2.7434842249657063e76, 273: 2.7434842249657063e76, 281: 6.858710562414266e76, 282: 6.858710562414266e76, 291: 2.143347050754458e77, 292: 2.143347050754458e77, 301: 8.573388203017832e77, 
	302: 2.6791838134430725e78, 303: 8.573388203017832e77, 311: 8.573388203017832e77, 312: 8.573388203017832e77, 321: 2.6791838134430727e76, 322: 1.808449074074074e78, 323: 2.6791838134430727e76, 
	...
	costs:{time:{},
		...
		mc:{}},
	costmults:{241: 1, 251: 2.5, 252: 2.5, 253: 2.5, 261: 6, 262: 6, 263: 6, 264: 6, 265: 6, 266: 6, 271: 2, 272: 2, 273: 2, 281: 4, 282: 4, 291: 1, 292: 1, 301: 2, 302: 2, 303: 2, 311: 64, 
		312: 64, 321: 2, 322: 2, 323: 2, 331: 3, 332: 3, 341: 2, 342: 2, 343: 2, 344: 2, 351: 4, 361: 1, 362: 1},
	costmult:1,
	allTimeStudies:[241, 251, 252, 253, 261, 262, 263, 264, 265, 266, 271, 272, 273, 281, 282, 291, 292, 301, 302, 303, 311, 312, 321, 322, 323, 331, 332, 341, 342, 343, 344, 351, 361, 362],
...
function updateMasteryStudyButtons() {
	...
	if (player.masterystudies.includes("d11")) {
		document.getElementById("ts361Current").textContent="Currently: 1/"+shorten(1/getMTSMult(361))+"x"
	}
}
...
function canBuyMasteryStudy(type, id) {
	if (type=='t') {
		...
		var col=id%10
		if (row>35) return player.masterystudies.includes('d11')
...
function getMTSMult(id) {
	...
	if (id==361) return Decimal.pow(0.95,player.dilation.tachyonParticles.add(1).log10())
}
...
function hatchSpeedDisplay(next) {
	...
	if(player.masterystudies.includes("t361")) speed = speed*getMTSMult(361)
