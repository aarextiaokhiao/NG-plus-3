...
function doQuantumProgress() {
	let names = Object.keys(ngp3Features)
	let data = Object.values(ngp3Features)
	while (data[tmp.ngp3_progress].met()) tmp.ngp3_progress++

	data = data[tmp.ngp3_progress]
	...
	el("progress").setAttribute('ach-tooltip', `${data.name}: ${data.req_disp(amt, req)}`)
}
