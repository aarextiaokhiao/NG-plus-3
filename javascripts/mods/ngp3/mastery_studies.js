const MTS = MASTERY_STUDIES = {
	...
	timeStudyEffects: {
		...
		322() {
			let log = Math.sqrt(Math.max(3 - getTickspeed().log10(), 0)) / (isBreakUpgActive(8) ? 200 : 2e4)
		...
		373: () => hasNU(14) ? pow10(Math.pow(player.galaxies, 4/3) / 5e5) : Math.pow(player.galaxies+1,0.55),
	...
	timeStudyDescs: {
		...
		292: "Passively gain Tachyon Particles.",
