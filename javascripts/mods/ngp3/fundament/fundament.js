...
ghostifyAni = function(gain, amount, seconds=4) {
	...
	setTimeout(function() {
		el("ghostifyanigained").innerHTML = ghostified ? "You now have <b>" + shortenDimensions(amount) + "</b> Spectral Particles. (+" + shortenDimensions(gain) + ")" : "We were small until we grew up. A spectral realm..."
