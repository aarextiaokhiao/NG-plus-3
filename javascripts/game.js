...
function autoBuyerTick() {
    ...
    if (player.masterystudies) if (speedrunMilestonesReached>20&&player.quantum.autobuyer.enabled) if (quarkGain().gte(player.quantum.autobuyer.limit)) quantum(true, false, 0)
